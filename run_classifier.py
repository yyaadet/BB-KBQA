...
class NlpccpmwmProcessor(DataProcessor):
    """Processor for the MultiNLI data set (GLUE version)."""

    def get_train_examples(self, data_dir):
        """See base class."""
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "train_with_mention.csv")), "train")

    def get_dev_examples(self, data_dir):
        """See base class."""
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "dev_with_mention.csv")), "dev")

    def get_test_examples(self, data_dir):
        """See base class."""
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "infer9870_all_with_mention.csv")), "test")
...
class NlpccpmProcessor(DataProcessor):
    """Processor for the MultiNLI data set (GLUE version)."""
    ...
    def get_test_examples(self, data_dir):
        """See base class."""
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "infer9870_all.csv")), "test")
...
class NlpccxqProcessor(DataProcessor):
    """Processor for the MultiNLI data set (GLUE version)."""
    ...
    def get_test_examples(self, data_dir):
        """See base class."""
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "infer9870.csv")), "test")
...
class NlpccxqpmProcessor(DataProcessor):
    """Processor for the MultiNLI data set (GLUE version)."""
    ...
    def get_test_examples(self, data_dir):
        """See base class."""
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "test9870.csv")), "test")
...
def create_model(bert_config, is_training, input_ids, input_mask, segment_ids,
    ...
    #     one_hot_labels = tf.one_hot(labels, depth=num_labels, dtype=tf.float32)
    #
    #     per_example_loss = focal_loss(logits, one_hot_labels)
    #
    #     # per_example_loss = -tf.reduce_sum(one_hot_labels * log_probs, axis=-1)
    #     loss = tf.reduce_mean(per_example_loss)
    #
...
def main(_):
    ...
    processors = {
        'nlpccpm': NlpccpmProcessor,
        'nlpccpmwm': NlpccpmwmProcessor,
        'nlpccxq': NlpccxqProcessor,
        'nlpccxqpm': NlpccxqpmProcessor
    }
